...
public class TestRemove {
    ...
    @Benchmark
    public boolean remove_before(RepoState repoState, BeforeState before) {
        return repoState.orders.remove(before.order);
    }
    ...
    @Benchmark
    public boolean remove_after(RepoState repoState, AfterState after) {
